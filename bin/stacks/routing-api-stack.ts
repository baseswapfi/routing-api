import { SUPPORTED_CHAINS } from '@baseswapfi/smart-order-router'
...
export const CHAINS_NOT_MONITORED: ChainId[] = [ChainId.SCROLL, ChainId.BASE_GOERLI, ChainId.SCROLL_SEPOLIA]
